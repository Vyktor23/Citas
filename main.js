...
let mascotatipo = [
  {nombre: "Perro", img: 'https://th.bing.com/th/id/R.c9c01b20d59b067d7aa5173165e398be?rik=UvJQOviuzYS9OQ&pid=ImgRaw&r=0' },
  {nombre: "Gato", img: 'https://th.bing.com/th/id/OIP.kgXLBni2DG-kIvhudI-4iQHaHQ?rs=1&pid=ImgDetMain' },
  {nombre: 'Pájaro', img: 'https://th.bing.com/th/id/R.19d6a937fab9651426166e2d236b4105?rik=hF8uLFi%2biJIG5w&pid=ImgRaw&r=0' },
  {nombre: 'Hamster', img: 'https://th.bing.com/th/id/OIP.san5bhNJs4Qh1BgFoMi6vwHaHa?w=209&h=209&c=7&r=0&o=5&pid=1.7' },
  {nombre: 'Camaleón', img: 'https://th.bing.com/th/id/OIP.qwiAFDheomiu4FDUMreezAAAAA?w=214&h=193&c=7&r=0&o=5&pid=1.7' },
  {nombre: 'Lagarto', img: 'https://th.bing.com/th/id/OIP.tGRHPJvvQ3Us_I1bjneF4QHaFp?w=250&h=190&c=7&r=0&o=5&pid=1.7' },
  {nombre: 'Araña', img: 'https://th.bing.com/th/id/R.b121aae54de0a178f8646329686894c7?rik=39CnTxtz%2ft1%2bWg&pid=ImgRaw&r=0&sres=1&sresct=1' },
  {nombre: 'Conejo', img: 'https://th.bing.com/th/id/OIP.ViVXHoBbw9JAoHpZjA7ioQHaHa?w=198&h=198&c=7&r=0&o=5&pid=1.7' },
  {nombre: 'Pez', img: 'https://th.bing.com/th/id/OIP.-CTJnj3rASTriQekN_W-xQHaF_?w=223&h=180&c=7&r=0&o=5&pid=1.7' },
  {nombre: 'Otro', img: 'https://th.bing.com/th/id/OIP.oKpLwd5-O5AlX50ue-dZzQHaFL?w=282&h=196&c=7&r=0&o=5&pid=1.7' }
]

function cambiarImagenMascota(tipoMascota) {
  let imagenMascota = document.getElementById("imagenMascota");

  let mascotaInfo = mascotatipo.find(
...
function mostrarCita() {
  ...
  citas.forEach((item, index) => {
    ...
    let tipoMascotaInfo = mascotatipo.find((tipo) => tipo.nombre === item.tipo)?.img;
    img.src = tipoMascotaInfo ? tipoMascotaInfo : "";
    img.alt = `imagen ${item.tipo}`;
    img.classList.add("imagen2");
    let ppropietario = document.createElement('p');
    let opciones1 = document.createElement('p');
    opciones1.textContent = `mascota: ${item.tipo}`;
...
//     let spannombre = document.createElement('span');
//     let img = document.createElement("img");
//     let src = mascotatipo.find((citas) => citas.nombre === item.tipoMascota)?.img;
//     img.src = src ? src : "";
//     img.alt=`imagen  ${item.tipo}`
//     img.classList.add("imagen2")
//     let ppropietario = document.createElement('p');
